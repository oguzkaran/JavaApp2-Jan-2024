...
public class RandomPasswordGeneratorSync {
    ...
    public RandomPasswordGeneratorSync(int count, int min, int max, short nThreads, ExecutorService threadPool)
    {
        this(count, min, max, nThreads, new Random(), threadPool);
    }

    public RandomPasswordGeneratorSync(int count, int min, int max, short nThreads, Random random, ExecutorService threadPool)
    {
        m_count = count;
        m_min = min;
        m_max = max;
    ...
    public List<String> run() throws ExecutionException, InterruptedException
    {
        this.submitThreads();
        awaitFutures();
    ...
    public List<String> run(long timeout, TimeUnit unit) throws ExecutionException, InterruptedException, TimeoutException
    {
        this.submitThreads();
